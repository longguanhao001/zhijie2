...
class Assert():
    ...
    def assert_in(self, expect, actul):
        assert actul in expect, "{0}不包含{1}".format(expect, actul)

    def assert_not_in(self, expect, actul):
    ...
    def assert_greaterAndEqual(self, expect, actul):
        assert actul >= expect, "{0}大于等于{1}".format(expect, actul)

    def assert_lessAndEqual(self, expect, actul):
